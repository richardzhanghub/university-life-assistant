...
public class EventListFragment extends Fragment {
    ...
    private TextView textViewEmptyEventList;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        textViewEmptyEventList = view.findViewById(R.id.empty_event_list);
        ...
        viewModel.getEvents().observe(getViewLifecycleOwner(), new Observer<List<Event>>() {
            ...
            public void onChanged(@Nullable List<Event> events) {
                if (events != null && !events.isEmpty()) {
                    ...
                    textViewEmptyEventList.setVisibility(View.GONE);
                } else {
                    recyclerView.setVisibility(View.GONE);
                    textViewEmptyEventList.setVisibility(View.VISIBLE);
                }
